...
export default function SectionWrapper(props) {
    const{children, header ,title, id } = props; /*can be used to display children of the tage as well */
  return (
    <>
    <section id={id} className='min-h-screen flex flex-col gap-10'>
        <div className="bg-slate-950 py-10 flex flex-col gap-2 items-center justify-center p-4">
